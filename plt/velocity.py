# This file velocity.py is part of kuramoto-sivashinksy.
#
# It plots the evolution over time of the velocity-field.
#
...
header, field = ReadFile("data/velocity.dat", 1, " ")
t = field[0]
u = field[1:]
...
plt.ylim(0., x[-1][0])
plt.tight_layout()
plt.savefig("plt/velocity_L%.2f.png" % header["L"], dpi=300)
